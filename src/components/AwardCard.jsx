...
const AwardCard = ({ imageSrc, heading, paragraph }) => {
  return (
    <div className="bg-white flex flex-col gap-5 shadow-xl hover:shadow-2xl rounded-xl p-4 hover:bg-[#AA8f00] group">
      <img
        src={imageSrc}
        alt="title"
      ...
      <h2 className="text-gray-700 text-md group-hover:text-white">
        {heading}
      </h2>
